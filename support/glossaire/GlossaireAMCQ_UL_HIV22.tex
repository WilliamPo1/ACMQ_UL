...
\definecolor{rstudio2}{HTML}{111c1c}
...
\pagecolor{rstudio2}
\noindent
\includegraphics[width=13.6cm]{_graphs/literary-joust-1.jpg}\\[-1em]
\color{cloud}
...
\entry{Constante}{Caractérise un \textbf{espace échantillonnal} à \emph{un} seul élément. Se produit lorsque le phénomène retourne toujours le même résultat. En opposition à \textbf{variable}}{\citep[p.~39]{VAB2020}}.
...
\entry{Dispersion, mesure de}{Mesure qui permet d'identifier le positionnement des observations sur la distribution. Y-a-t-il une concentration d'observations autour du centre où sont elles éparpillées sur toute la distribution}{\citep[p.~52]{VAB2020}}?
...
\entry{Écart interquartile}{\textbf{Mesure de dispersion} calculant la distance entre le $25^{e}$ \textbf{centile} (ou $1^{er}$ quartile) et le $75^{e}$ centile (ou $3^{e}$ quartile). Plus l’écart interquartile est grand, plus les observations ont tendance à s’éloigner du centre de la distribution. Cette mesure n'est pas affectée par les valeurs extrêmes ou aberrantes comme la \textbf{variance} ou l'\textbf{écart-type}}{\citep[p.~54]{VAB2020}}.
...
\entry{Indépendance}{Deux variables sont indépendantes si la valeur qu’assume une des variables n’a aucune relation avec la probabilité de l’autre. Par exemple, la taille d'une personne et sa religion sont deux variables indépendantes puisqu'il n'y a pas de lien entre mesurer 6'2 et être catholique ou protestant. Cependant le lieu de résidence et la religion ne sont pas des variables indépendantes puisque le fait de vivre au Vatican augmente la probabilité d'être catholique et le fait de vivre à Tokyo la diminue}{\citep[p.~43]{VAB2020}}.
...
\entry{Mesure}{Processus permettant d'établir des observations empiriques reliées à un concept donné. Un \textbf{indicateur} est une procédure spécifique de mesure}{\citep[p.~337]{RSI2010}}.
...
\entry{Postulat}{Principe que l’on demande d’admettre comme vrai sans démonstration.}{}
...
\entry{Statistiques descriptives}{Voir \textbf{Inférence descriptive}}.

\entry{Statistiques inférentielles}{Voir \textbf{inférence statistique}}.
%----------------------------------------------------------------------------------------
%	SECTION T
%----------------------------------------------------------------------------------------
\section*{T}
...
\entry{Variable}{Une représentation algébrique de l'\textbf{espace échantillonnal}}{\citep[p.~38-39]{VAB2020}}.

\entry{Variable binaire}{Lié à un espace échantillonnal qui comprend seulement deux éléments : vrai/faux, oui/non, 1/0, etc.}{\citep[p.~39]{VAB2020}}.
...
\entry{Variable dépendante, Y}{Ce que le chercheur cherche à expliquer. Elle est hypothétiquement supposée être causée par ou «~dépendre~» d’une ou plusieurs variables indépendantes. On l'appelle aussi variable expliquée}{\multicitep{VAB2020, p.~77; RSI2010, p.~325}}.

\entry{Variable indépendante, X}{Une variable qui influence, ou est hypothétiquement supposée influencer, la variable dépendante}{\multicitep{VAB2020, p.~77; RSI2010, p.~332}}.

\entry{Variable intervalle}{Représente des catégories de données avec un ordre logique et une distance précise entre chaque catégorie : la température. Ce type de variable est pertinent pour la statistique comme les mesures de la tendance centrale et de dispersion peuvent y être appliquées.}

\entry{Variable latente}{Un attribut ou une caractéristique observée grâce à des \textbf{indicateurs} qui le mesurent indirectement}{\citep[p.~335]{RSI2010}}.
...
\entry{Variable ordinale}{Représente des catégories de données : Tout à fait d'accord, D'accord, Neutre, Pas d'accord, Pas du tout d'accord. Il est possible de mettre ces catégories en ordre, mais la distance entre les catégories n'est pas nécessairement la même}{\citep[p.~39]{VAB2020}}.

\entry{Variable ratio}{Représente des catégories de données avec une ordre logique et une distance précise entre chaque catégorie et une \emph{zéro naturel} : temps, grandeur, etc. Ce type de variable est pertinent pour la statistique comme les mesures de la tendance centrale et de dispersion peuvent y être appliquées.}.
